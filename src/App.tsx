      ...
      >
        <div className="flex items-center gap-4 group cursor-pointer">
          <div className="w-12 h-12 flex items-center justify-center overflow-hidden">
            <img src="/LOGOSOLO.png" alt="Logo Protección Financiera" className="w-full h-full object-contain" referrerPolicy="no-referrer" />
          </div>
        </div>
      ...
      <section id="autonomos" className="py-32 bg-white scroll-mt-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
          <motion.div 
            ...
            className="relative"
          >
             <img src="Gemini_Generated_Image_brfhutbrfhutbrfh.png" alt="Autónomos" className="rounded-[3rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] grayscale-[20%]" referrerPolicy="no-referrer" />
             <motion.div 
          ...
          <div className="col-span-2">
            <div className="flex items-center gap-5 mb-12">
                <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center overflow-hidden shadow-2xl">
                    <img src="/LOGOSOLO.png" alt="Logo" className="w-14 h-14 object-contain" referrerPolicy="no-referrer" />
                </div>
            </div>
